...
public class PostControllerTest extends ReadinControllerTestBase {
    ...
    public void testUpdatePost() {
        ...
        assertThrows(ResponseStatusException.class, () -> postController.updatePost(mockRequest("userNon", "notAuthenticated"), 34, postId, new UpdatePostDto("updatedPost2OfUser1")));
    ...
    public void testGetTimeLinePosts() {
        AppUserDto followee1 = appUserController.createAppUser(new CreateAppUserDto("followee1", "password2"));
        AppUserDto followee2 = appUserController.createAppUser(new CreateAppUserDto("followee2", "password3"));
        followingController.followUser(user0(), appUserId, followee1.id());
        followingController.followUser(user0(), appUserId, followee2.id());
        postController.createPost(user0(), followee1.id(), "post1OfFollowee1", null);
        postController.createPost(user0(), followee2.id(), "post1OfFollowee2", null);
