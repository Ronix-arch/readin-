...
@Test
public void testPostsListEmpty() {assertTrue(postController.getOwnPosts(user0(), appUserId).isEmpty());}

  @Test public void testCreatePostAndListPosts() {
  ...
  List<PostDto> posts = postController.getOwnPosts(user0(), appUserId);
  ...
  @Test public void testUpdatePost() {
...
@Test public void testGetTimeLinePosts() {
 ...
 List<PostDto> timelinePosts = postController.getTimeLinePosts(user0(),appUserId);
